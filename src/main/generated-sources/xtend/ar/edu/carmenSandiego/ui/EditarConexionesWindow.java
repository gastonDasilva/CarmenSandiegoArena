...
public class EditarConexionesWindow /* extends /* TransactionalDialog<PaisAppModel> */  */{
  public EditarConexionesWindow(final WindowOwner owner, final /* PaisAppModel */Object model) {
    super(owner, model);
  ...
  protected void createFormPanel(final Panel mainPanel) {
    throw new Error("Unresolved compilation problems:"
      ...
      + "\nagregarPaisConexionSelec cannot be resolved");
  }
  
  public void createGridActions(final Panel mainPanel) {
    throw new Error("Unresolved compilation problems:"
      + "\neliminarPaisConexionSeleccionado cannot be resolved");
  }
