...
public class EditarLugaresDeInteresWindow /* extends /* TransactionalDialog<PaisAppModel> */  */{
  public EditarLugaresDeInteresWindow(final WindowOwner owner, final /* PaisAppModel */Object model) {
    super(owner, model);
  ...
  protected void createFormPanel(final Panel mainPanel) {
    throw new Error("Unresolved compilation problems:"
      ...
      + "\nagregarLugarDeInteresSelec cannot be resolved");
  }
  
  public void createGridActions(final Panel mainPanel) {
    throw new Error("Unresolved compilation problems:"
      + "\neliminarLugarSeleccionado cannot be resolved");
  }
